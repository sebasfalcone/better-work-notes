...
- [Flyweight](https://refactoring.guru/design-patterns/flyweight/cpp/example) Lets you fit more objects into the available amount of RAM by sharing common parts of state between multiple objects instead of keeping all of the data in each object.
...
- [Observer](https://refactoring.guru/design-patterns/observer/cpp/example) Lets you define a subscription mechanism to notify multiple objects about any events that happen to the object they're observing.
...
- [Template Method](https://refactoring.guru/design-patterns/template-method/cpp/example) Defines the skeleton of an algorithm in the superclass but lets subclasses override specific steps of the algorithm without changing its structure.
